...
<!-- ===================== -->
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=30&pause=1000&color=38BDF8&center=true&vCenter=true&width=900&lines=Hi+there+👋+I'm+Enes+Mumeita;Flutter+Mobile+Developer;Data+Science+%26+Machine+Learning;Building+Beautiful+Apps+Powered+by+Data" />
</p>
...
- Building **data-driven mobile features**
- Experimenting with **ML models** and deploying them via APIs or on-device inference

🎯 My long-term goal is to **bridge mobile development with intelligent systems**.
...
- **ds-experiments** — EDA, ML baselines, and data visualizations  
...
## 🔥 GitHub Streak (Visible & Centered)
<p align="center">
...
<!-- ===================== -->
<!-- Snake Animation (after workflow setup) -->
<!-- ===================== -->
## 🐍 Contribution Snake
<p align="center">
